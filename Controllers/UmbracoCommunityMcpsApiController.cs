...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "Umbraco.Community.Mcps")]
    public class UmbracoCommunityMcpsApiController : UmbracoCommunityMcpsApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public UmbracoCommunityMcpsApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
