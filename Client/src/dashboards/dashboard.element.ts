...
import { UmbracoCommunityMcpsService, UserModel } from "../api/index.js";
...
export class ExampleDashboardElement extends UmbElementMixin(LitElement) {
  ...
  #onClickWhoAmI = async (ev: Event) => {
    ...
    const { data, error } = await UmbracoCommunityMcpsService.whoAmI();
  ...
  #onClickWhatsTheTimeMrWolf = async (ev: Event) => {
    ...
    const { data, error } = await UmbracoCommunityMcpsService.whatsTheTimeMrWolf();
  ...
  #onClickWhatsMyName = async (ev: Event) => {
    ...
    const { data, error } = await UmbracoCommunityMcpsService.whatsMyName();
