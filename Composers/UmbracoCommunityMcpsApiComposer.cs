...
{
    public class UmbracoCommunityMcpsApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Community Mcps Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoCommunityMcpsOperationSecurityFilter>();
            });
        }

        public class UmbracoCommunityMcpsOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.Mcps.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
